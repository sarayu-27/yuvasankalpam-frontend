              ...
              <div className="answer-status">
                  {q.questionType === "mcq" ? (
                    q.selectedAnswer === q.correctAnswer ? (
                      <span className="correct-answer"><i className="material-icons">check</i> Selected Correct Answer</span>
                    ) : q.selectedAnswer !== null ? (
                      <span className="wrong-answer"><i className="material-icons">close</i> Selected Wrong Answer</span>
                    ) : (
                      <span className="not-attempted"><i className="material-icons">warning</i> Not Attempted</span>
                    )
                  ) : (
                    <span className="text-answer-status">
                      {q.explanation ? (
                        <span className="correct-answer"><i className="material-icons">check</i> Answer Submitted</span>
                      ) : (
                        <span className="not-attempted"><i className="material-icons">warning</i> Not Attempted</span>
                      )}
                    </span>
